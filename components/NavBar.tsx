...
import { BarChart2, LayoutDashboard, Video, ArrowLeft, Users } from "lucide-react";
...
export default function NavBar() {
  ...
  // ── Global nav ───────────────────────────────────────────────────────────
  const globalLinks = [
    { href: "/rooms", label: "Manage Rooms", icon: Users    },
    { href: "/join",  label: "Join a Room",  icon: Video    },
  ];
